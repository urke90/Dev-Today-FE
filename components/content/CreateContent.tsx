                      ...
                      >
                        {({ open }) => (
                          ...
                          >
                            ...
                            />
                            <span
                              className={`subtitle-medium ${field.value ? 'bg-green-400 text-white-400 dark:bg-green-700 dark:!text-white-100' : 'bg-white-200 dark:bg-black-700'}  rounded-md px-2 py-1 tracking-wide`}
                            >
