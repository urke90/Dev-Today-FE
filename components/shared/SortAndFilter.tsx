    ...
    <div className="left-sidebar-item max-md:items-center">
      ...
      <div className="flex md:flex-col gap-2.5">
        <Link
          ...
          className={`flex items-center gap-2.5 rounded-md py-1 px-[5px] md:py-1.5 hover:dark:bg-black-700 hover:bg-[#F8FAFC] transition-colors cursor-pointer ${sortBy === ESortByFilter.RECENT ? activeClassName : ''}`}
        >
        ...
        <Link
          ...
          className={`flex items-center gap-2.5 rounded-md py-1 px-[5px] md:py-1.5 hover:dark:bg-black-700 hover:bg-[#F8FAFC] transition-colors cursor-pointer ${sortBy === ESortByFilter.POPULAR ? activeClassName : ''}`}
        >
        ...
        {isGroupPage ? (
          <Link
            ...
            className={`flex items-center gap-2.5 rounded-md py-1 px-[5px] md:py-1.5 hover:dark:bg-black-700 hover:bg-[#F8FAFC] transition-colors cursor-pointer ${sortBy === ESortByFilter.JOINED ? activeClassName : ''}`}
          >
